            ...
            <tbody>
                @foreach ($photos as $index => $photo)
                    <tr>
                        ...
                        <td>{{ $photo->title }}</td>
                        <td>
                            <button class="btn btn-info btn-view" data-id="{{ $photo->id }}">Lihat</button>
                            <button class="btn btn-primary btn-edit" data-id="{{ $photo->id }}">Edit</button>
                            <button class="btn btn-danger btn-delete" data-id="{{ $photo->id }}">Hapus</button>
                        </td>
                    </tr>
                @endforeach
            </tbody>
